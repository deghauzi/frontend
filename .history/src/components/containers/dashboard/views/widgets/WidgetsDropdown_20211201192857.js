  ...
  const mainAccountBal =
    mainAccount.length && mainAccount.map(acc =>{
      return(
        ...
        <h4 className="mt-2 font-weight-bold>Account No:{" "}{acc.bank_account_no}</h4>
        ...
        <div className="d-block pr-3">
             ...
             <p className="total-donations-received font-weight-500">
    ...
    console.log(mainAccountBal)
    console.log(mainAccountBal.bank_account_balance)
    ...
    bonusAccount.length && bonusAccount.map(acc => {
      return(
        ...
        <div className=" d-flex justify-content-between pr-3">
          ...
          <div className="d-flex justify-content-between pr-3">
            <h4 className="mt-2 font-weight-bold">Balance: ₦{numeral(acc.total_amount).format("0,0")}</h4>
